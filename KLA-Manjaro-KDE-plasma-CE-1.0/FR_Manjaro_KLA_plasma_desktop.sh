...
wget -c https://gitlab.com/sofija.p2018/kla-ot2/-/raw/main/KLA-Manjaro-KDE-plasma/plugin/f_00_Arch_KDE_plasma_manjaro_no-kernel.plug
...
wget -c https://gitlab.com/sofija.p2018/kla-ot2/-/raw/main/KLA-Manjaro-KDE-plasma/kla-module/archstrap_wiak_mod.sh && chmod +x archstrap_wiak_mod.sh
...
./build_firstrib_rootfs.sh arch default amd64 f_00_Arch_KDE_plasma_manjaro_no-kernel.plug
